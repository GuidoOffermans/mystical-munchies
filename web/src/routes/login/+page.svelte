		...
		<div class="mx-auto w-full max-w-sm lg:w-96">
			<div>
				...
				<p class="mt-2 text-sm leading-6">
					Not a member?
					<a href="/register" class="font-semibold">sign up here</a>
				</p>
			</div>
						...
						<div class="flex items-center justify-between">
							<div class="flex items-center">
								<input
									...
									class="checkbox"
								/>
								<label for="remember-me" class="ml-3 label">Remember me</label>
							</div>
...
<!--							</div>-->
						...
						<div>
							<button
								type="submit"
								class="flex w-full justify-center btn variant-filled-primary"
							>
								Sign in
							</button>
						</div>
